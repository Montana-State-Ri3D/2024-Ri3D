...
public class DriveCommand extends Command {
  ...
  @Override
  public void execute() {
    wheelSpeeds = DifferentialDrive.arcadeDriveIK(Joystick.JoystickInput(xSpeed.getAsDouble(), 3, 0.005, .75),
        -Joystick.JoystickInput(zRotation.getAsDouble(), 2, 0.005, .75), false);
